...
/** 滑块 */
@property (nonatomic, strong) YDSliderButton *sliderBtn;
...
- (YDSliderButton *)sliderBtn {
    if (!_sliderBtn) {
        _sliderBtn = [YDSliderButton buttonWithType:UIButtonTypeCustom];
