...
@interface YDLandScapeControlView () <YDSliderViewDelegate>
/// 顶部工具栏
...
/// 滑杆
@property (nonatomic, strong) YDSliderView *slider;
/// 视频总时间
...
@implementation YDLandScapeControlView
...
- (YDSliderView *)slider {
    if (!_slider) {
        _slider = [[YDSliderView alloc] init];
