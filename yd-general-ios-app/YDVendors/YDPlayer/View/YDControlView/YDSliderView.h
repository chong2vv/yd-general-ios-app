...
@protocol YDSliderViewDelegate <NSObject>
...
@interface YDSliderButton : UIButton

@end

@interface YDSliderView : UIView

@property (nonatomic, weak) id<YDSliderViewDelegate> delegate;

/** 滑块 */
@property (nonatomic, strong, readonly) YDSliderButton *sliderBtn;
