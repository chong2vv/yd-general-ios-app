...
#import "YDVolumeBrightnessView.h"

@interface YDPlayerControlView () <YDSliderViewDelegate>
/// 竖屏控制层的View
@property (nonatomic, strong) YDPortraitControlView *portraitControlView;
/// 横屏控制层的View
@property (nonatomic, strong) YDLandScapeControlView *landScapeControlView;
/// 加载loading
@property (nonatomic, strong) YDSpeedLoadingView *activity;
/// 快进快退View
@property (nonatomic, strong) UIView *fastView;
/// 快进快退进度progress
@property (nonatomic, strong) YDSliderView *fastProgressView;
/// 快进快退时间
...
/// 底部播放进度
@property (nonatomic, strong) YDSliderView *bottomPgrogress;
/// 是否显示了控制层
...
@property (nonatomic, strong) YDSmallFloatControlView *floatControlView;

@property (nonatomic, strong) YDVolumeBrightnessView *volumeBrightnessView;
...
@implementation YDPlayerControlView
...
- (YDPortraitControlView *)portraitControlView {
    if (!_portraitControlView) {
        @weakify(self)
        _portraitControlView = [[YDPortraitControlView alloc] init];
...
- (YDLandScapeControlView *)landScapeControlView {
    if (!_landScapeControlView) {
        @weakify(self)
        _landScapeControlView = [[YDLandScapeControlView alloc] init];
...
- (YDSpeedLoadingView *)activity {
    if (!_activity) {
        _activity = [[YDSpeedLoadingView alloc] init];
    }
    return _activity;
}
...
- (YDSliderView *)fastProgressView {
    if (!_fastProgressView) {
        _fastProgressView = [[YDSliderView alloc] init];
...
- (YDSliderView *)bottomPgrogress {
    if (!_bottomPgrogress) {
        _bottomPgrogress = [[YDSliderView alloc] init];
...
- (YDSmallFloatControlView *)floatControlView {
    if (!_floatControlView) {
        _floatControlView = [[YDSmallFloatControlView alloc] init];
        @weakify(self)
...
- (YDVolumeBrightnessView *)volumeBrightnessView {
    if (!_volumeBrightnessView) {
        _volumeBrightnessView = [[YDVolumeBrightnessView alloc] init];
