...
#import "YDPortraitControlView.h"
#import "YDLandScapeControlView.h"
#import "YDSmallFloatControlView.h"
#import "YDSpeedLoadingView.h"
...
/// 竖屏控制层的View
@property (nonatomic, strong, readonly) YDPortraitControlView *portraitControlView;

/// 横屏控制层的View
@property (nonatomic, strong, readonly) YDLandScapeControlView *landScapeControlView;

/// 加载loading
@property (nonatomic, strong, readonly) YDSpeedLoadingView *activity;

/// 快进快退View
@property (nonatomic, strong, readonly) UIView *fastView;

/// 快进快退进度progress
@property (nonatomic, strong, readonly) YDSliderView *fastProgressView;
...
/// 底部播放进度
@property (nonatomic, strong, readonly) YDSliderView *bottomPgrogress;
...
/// 小窗口控制层
@property (nonatomic, strong, readonly) YDSmallFloatControlView *floatControlView;
