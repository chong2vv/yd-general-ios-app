...
- (UIImage *)p_resizeImageSize:(CGSize)size
{
...
- (NSData *)halfFuntionForMaxFileSize:(NSInteger)maxSize
{
    ...
    NSData *finallImageData = UIImageJPEGRepresentation(self,1);
    ...
    while(start < end) {
        ...
        if(index >= arr.count) {
            tempData = UIImageJPEGRepresentation(self, 1.);
            return tempData;
        }
        finallImageData = UIImageJPEGRepresentation(self,[arr[index] floatValue]);
        
        NSUInteger sizeOrigin = finallImageData.length;
        NSUInteger sizeOriginKB = sizeOrigin / 1024;
        NSLog(@"leoliu 当前降到的质量：%ld", (unsigned long)sizeOriginKB);
